...
- 2026-07-28: local Skill/contract/MCP stdio tests and GitHub Actions on Windows plus macOS 14 passed, including native AppKit/ApplicationServices/Quartz imports and the pinned release checksum.
